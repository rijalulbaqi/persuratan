      ...
      <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form action="{{ url('admin/pengguna/ubahsuratkeluar') }}" method="post" enctype="multipart/form-data">
                  @csrf
                  <input name="id" type="hidden" class="form-control" required value="{{ $suratkeluar->id }}">
                  <div class="form-group">
                  <label for="nomor_surat" class="col-sm-3 col-form-label">Nomor Surat</label>
                  <div>
                    <input name="nomor_surat" type="text" class="form-control" required value="{{ $suratkeluar->nomor_surat }}">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div>
                    <input name="perihal" type="text" class="form-control" required value="{{ $suratkeluar->perihal }}">
                  </div>
                </div>
                <div class="form-group">
